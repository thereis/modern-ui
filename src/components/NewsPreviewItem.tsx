  ...
  return (
    <div className="">
      <Link to="/community/news/2">
        <div className="bg-gray-100 p-1 overflow-hidden border mr-2 border-gray-400 rounded">
          <div
          ...
          <div className="w-full p-1 border-b border-gray-200">
            <div className="flex justify-between mb-1">
              <p className="text-xs border border-gray-400 rounded px-1 text-gray-500">Event</p>
